 ...
 */
//@WebServlet("/qwe/asd/LotteryServlet")
@WebServlet("/ch05_04/LotteryServlet")
public class LotteryServlet extends HttpServlet {
	...
	private void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
       try {
           ...
           RequestDispatcher rd = request.getRequestDispatcher("/ch01/goodLuck.jsp");// 準備將移轉程式的執行順序//此斜線為應用系統根目錄(jsp的方法)
