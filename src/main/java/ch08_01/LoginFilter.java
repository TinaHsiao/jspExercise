...
@WebFilter(
		urlPatterns = { "/*" }, 
		initParams = { 
				@WebInitParam(name = "arg1", value = "/ch05_05/*"), 
				@WebInitParam(name = "arg2", value = "/ch05_08/*"), 
				@WebInitParam(name = "arg3", value = "/ch05_09/*"), 
				@WebInitParam(name = "arg4", value = "/ch07_02/*")
		})
public class LoginFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		if(request instanceof HttpServletRequest && response instanceof HttpServletResponse){
			...
			throw new ServletException("Reqest/Response Type Error");
		}
	}
	...
	public boolean mustLogin(String servletPath){
		boolean login = false;
